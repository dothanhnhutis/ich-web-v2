...
import { sortWarehouseData } from "@/constants";
    ...
    <div className="relative grid gap-4 border rounded-lg p-3">
      ...
      <div className="flex gap-4 items-center flex-col sm:flex-row">
        <InputGroup>
          <InputGroupInput
            type="text"
            placeholder="Tìm kiếm bằng tên nhà kho"
            value={searchName}
            onChange={(e) => {
          ...
          <InputGroupAddon align="inline-end" className="pr-2">
            <Button
              ...
              onClick={() => {
                const newSearchParams = new URLSearchParams(searchParams);
                if (searchName !== "") {
                  if (newSearchParams.has("address")) {
        ...
        <InputGroup>
          <InputGroupInput
            type="text"
            placeholder="Tìm kiếm bằng địa chỉ"
            value={searchAddress}
            onChange={(e) => {
          ...
          <InputGroupAddon
            ...
            className={cn(
              "p-0",
              searchAddress.length === 0 ? "hidden" : "block"
            )}
          >
            <button
              type="button"
        ...
        <div className="relative flex gap-4 items-center w-full sm:w-[180px]">
          ...
          <SortComponent data={sortWarehouseData} />
        </div>
      </div>
    </div>
  );
